...
<td ALIGN=left VALIGN=TOP BACKGROUND="r1_topbac.png">
 <A HREF="javascript:addItem('index.html','','ComputoGT','0.00','',1,0,0,0,'','')"><img src="r1_add.png" border=0></a><a HREF="javascript:removeItem('')"><img src="r1_remove.png" border=0></a></td>
-->
